...
const _hoisted_4 = ["type", "name"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [['text', 'email', 'password', 'date'].includes($props.inputType) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("label", {
    key: 0,
  ...
  }, null, 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_3)], 2 /* CLASS */)) : $props.inputType === 'hidden' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("input", {
    key: 1,
    type: $props.inputType,
    name: $props.label.replace(' ', '-').toLowerCase()
  }, null, 8 /* PROPS */, _hoisted_4)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" > ")], 64 /* STABLE_FRAGMENT */);
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c0646d5a1b873f51ff36")
/******/ })();
/******/ 
/******/ }
);