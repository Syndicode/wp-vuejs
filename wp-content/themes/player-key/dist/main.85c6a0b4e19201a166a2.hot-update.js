...
const router = (0,vue_router__WEBPACK_IMPORTED_MODULE_2__.createRouter)({
  ...
  routes: [{
    ...
    path: '/register/:role',
    component: Object(function webpackMissingModule() { var e = new Error("Cannot find module '../views/RegisterRoleView.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  }, {
    path: '/login',
    name: 'login',
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1bb05c2264a0ae562439")
/******/ })();
/******/ 
/******/ }
);