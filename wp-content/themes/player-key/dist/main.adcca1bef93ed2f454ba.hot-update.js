...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    isRequiredFieldsFiled() {
      ...
      _data_formFields_js__WEBPACK_IMPORTED_MODULE_2__["default"][this.$route.params.role].forEach(section => {
        section.fields.forEach(field => {
          console.log(field.isRequired, this.form[field.model]);
    ...
    async formSubmit() {
      ...
      await setTimeout(() => {
        (0,_api_authentication_js__WEBPACK_IMPORTED_MODULE_3__.registerUser)(this.form).then(response => {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b3329541866ee19333ad")
/******/ })();
/******/ 
/******/ }
);