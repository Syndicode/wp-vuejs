...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Heading, {
    ...
    label: `Login`,
    "input-type": `text`,
    modelValue: this.form.login,
    "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => this.form.login = $event)
  }, null, 8 /* PROPS */, ["modelValue"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_FormItem, {
    name: `password`,
    label: `Password`,
    "input-type": `password`,
    modelValue: this.form.password,
    "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => this.form.password = $event)
  }, null, 8 /* PROPS */, ["modelValue"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.form.login), 1 /* TEXT */)], 32 /* HYDRATE_EVENTS */)]);
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("e70bc9524395ce46bc93")
/******/ })();
/******/ 
/******/ }
);