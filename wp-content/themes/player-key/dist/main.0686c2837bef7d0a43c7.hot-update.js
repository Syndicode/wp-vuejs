...
const getEntitles = (entityType, data) => {
  return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`/entities/${entityType}`, data);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  getEntitles
});
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("85e05994e99209570db6")
/******/ })();
/******/ 
/******/ }
);