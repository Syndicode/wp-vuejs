...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteUpdate() {
    console.log('watch-- ', this.currentEntity);
  },
  watch: {
    '$route.params.entity': () => {
      console.log('watch-- ', undefined.currentEntity);
      // this.currentEntity = this.$route.params.entity
      // this.fetchData();
    }
  },
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7211c6db9c0aed3500ac")
/******/ })();
/******/ 
/******/ }
);