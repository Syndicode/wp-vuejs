...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../views/BoardView.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const router = (0,vue_router__WEBPACK_IMPORTED_MODULE_5__.createRouter)({
  ...
  routes: [{
    ...
    path: '/board',
    name: 'board',
    component: Object(function webpackMissingModule() { var e = new Error("Cannot find module '../views/BoardView.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  }]
});
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9f3e61168b3b42f4c772")
/******/ })();
/******/ 
/******/ }
);