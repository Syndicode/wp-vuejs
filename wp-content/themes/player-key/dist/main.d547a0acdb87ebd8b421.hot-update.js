...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../views/DashboardView.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const router = (0,vue_router__WEBPACK_IMPORTED_MODULE_5__.createRouter)({
  ...
  routes: [{
    ...
    path: '/dashboard',
    name: 'dashboard',
    component: Object(function webpackMissingModule() { var e = new Error("Cannot find module '../views/DashboardView.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  }]
});
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("df9f65e971f41b2bd4b3")
/******/ })();
/******/ 
/******/ }
);