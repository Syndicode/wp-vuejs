...
// Options pages
require_once TEMPLATE_DIR . '/inc/acf/options-pages/stripe.php';
require_once TEMPLATE_DIR . '/inc/acf/options-pages/payment.php';

// Fields
require_once TEMPLATE_DIR . '/inc/acf/fields/user.php';
require_once TEMPLATE_DIR . '/inc/acf/fields/user-role-parent.php';
